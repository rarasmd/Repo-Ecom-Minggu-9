...
<head>
    ...
    <!-- Font Awesome CSS -->
    <link href="<?= base_url('assets/admin') ?>/font-awesome/css/all.css" rel="stylesheet" type="text/css" />
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/admin') ?>/plugins/datatables/datatables.min.css" />
